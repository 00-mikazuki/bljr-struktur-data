...
// hitungAnggota single linked list
...
// tambahTengah single linked list
...
int main()
{
  ...
  changeLast ("One Piece", "Eichiro Oda", 2000);
  printSingleLinkedList ();
  cout << "\n\n" << endl;

  addMiddle ("Bumi Manusia", "Pramudya Ananta Toer", 2005, 2);
  printSingleLinkedList ();
  cout << "\n\n" << endl;
